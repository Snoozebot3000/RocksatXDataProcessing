...
this could have been incorperated into the first file it was felt to
be prudent to pull this into a seperate program to be able to reduce
...
file. This will allow for easy to parse and read calibration values for the system. The configuration file must exist in the path relative to this program of 
